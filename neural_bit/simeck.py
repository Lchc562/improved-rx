...
def make_train_data(n, nr, pairs, k=1, diff=(0x0000, 0x0002)):
    check_testvector_32()
    ...
    X = RXDR_convert_to_bits([delta_ctdata0l, delta_ctdata0r, delta_secondLast_ctdata0r], 3)
...
def make_train_demo(n, nr, k=1, diff=(0x0000, 0x0002)):
    check_testvector_32()
    ...
    return [delta_ctdata0l, delta_ctdata0r]


# x = make_train_demo(6, 6, k=1, diff=(0x0, 0x04))
# num_block = int(len(x) / 16)
# print(num_block)
# print(x)
